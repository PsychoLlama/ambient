...
// Fully-qualified foreign enum-variant resolution (every spelling, as
// constructor and pattern, and the same-named-local-variant decoy) lives in
// its own suite: `tests/cross_module_enum_variants.rs`.
