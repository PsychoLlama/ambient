...
mod tests {
    ...
    #[test]
    fn test_eval_function_returning_local_identifier() {
        let func = Resource::FunctionDefinition {
            // Ugh. It might be easier to represent this as a value instead of a statement.
            // Otherwise I need some way for functions to hold a list of statements, and that means
            // considering empty lists or values after `return`. Do not want.
            body: Box::new(Expression::Literal(Literal::Identifier(0))),
        };
    }
}
